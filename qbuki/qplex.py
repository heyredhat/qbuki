# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/qplex.ipynb.

# %% auto 0
__all__ = ['flatten', 'vol_simplex', 'vol_psic', 'sample_qplex_surface_point', 'sample_qplex', 'sample_hilbert_qplex', 'mc_batch',
           'cvx_batch', 'mc_qplex_vol', 'mc_qplex_vol_error_bars', 'cvx_qplex_vol', 'tconstraint', 'tcompare',
           'consistent', 'qplex_halfspace_intersection', 'john_plex', 'in_hull', 'add_new_point_on_outsphere',
           'add_if_consistent', 'permutations_of', 'add_if_consistent_recursive', 'non_increasing']
