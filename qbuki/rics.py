# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/rics.ipynb.

# %% auto 0
__all__ = ['mercedes_benz_frame', 'circular_shifts', 'icosahedron_vertices', 'icosahedron_frame', 'petersen_frame', 'honey_frame']
